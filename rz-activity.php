...
function rz_user_activity()
{
    global $wpdb;
    $nonce = $_POST['nonce'];
    if (wp_verify_nonce($nonce, 'rz-activity-view')) {
        $start = sanitize_key($_POST['start']);

        /**
         * get all feature post ids
         */
...
?>
                    <li>
                        <a href="<?php echo get_permalink($get_activity_data->ID); ?>" class="activity-link d-flex flex-row justify-content-start align-items-start">
                            <div class="activity-image">
                                <img src="<?php echo getProfileImageById($get_activity_data->post_author); ?>" alt="" style="min-width: 42px;">
                            </div>
                            <div class="activity-description ms-2">
                                <p class="mb-0 rz-secondary-color imit-font fw-400 fz-16">New question <span class="imit-font rz-color fw-500"><?php echo $get_activity_data->post_title; ?></span> asked <span class="created-at"><?php echo human_time_diff(strtotime($get_activity_data->post_date), strtotime($start_date)); ?> ago</span></p>
                            </div>
                        </a>
                    </li>
                <?php
                ...
                ?>
                    <li>
                        <a href="<?php echo get_permalink($post_id->post_id); ?>" class="activity-link d-flex flex-row justify-content-start align-items-start">
                            <div class="activity-image">
                                <img src="<?php echo getProfileImageById($answer_activity->user_id); ?>" alt="" style="min-width: 42px;">
                            </div>
                            <div class="activity-description ms-2">
                                <p class="mb-0 rz-secondary-color imit-font fw-400 fz-16"><?php echo ucfirst(getUserNameById($answer_activity->user_id)); ?> answered <span class="imit-font rz-color fw-500"><?php echo wp_trim_words($answer_activity->post_title, 10, ' ...'); ?></span> <span class="created-at"><?php echo human_time_diff(strtotime($answer_activity->created_at), strtotime($start_date)); ?> ago</span></p>
                            </div>
                        </a>
                    </li>
                <?php
                ...
                ?>
                    <li>
                        <a href="<?php echo get_permalink($post_id->post_id); ?>" class="activity-link d-flex flex-row justify-content-start align-items-start">
                            <div class="activity-image">
                                <img src="<?php echo getProfileImageById($vote_activity->vote_user_id); ?>" alt="" style="min-width: 42px;">
                            </div>
                            <div class="activity-description ms-2">
                                <p class="mb-0 rz-secondary-color imit-font fw-400 fz-16"><?php echo ucfirst(getUserNameById($vote_activity->vote_user_id));
                                                                                            if ($vote_activity->vote_type == 'up-vote') {
                                                                                                echo ' upvoted ';
                                                                                            } else {
                                                                                                echo ' downvoted ';
                                                                                            }
                                                                                            echo ucfirst(getUserNameById($vote_activity->answer_user_id)); ?>'s answer for <span class="imit-font rz-color fw-500"><?php echo wp_trim_words($post_data->post_title, 10, false); ?></span> <span class="created-at"><?php echo human_time_diff(strtotime($vote_activity->time), strtotime($start_date)); ?> ago</span></p>
                            </div>
                        </a>
                    </li>
                <?php
                ...
                ?>
                    <li>
                        <a href="<?php echo get_permalink($post->ID); ?>" class="activity-link d-flex flex-row justify-content-start align-items-start">
                            <div class="activity-image">
                                <img src="<?php echo getProfileImageById($comment->user_id); ?>" alt="" style="min-width: 42px;">
                            </div>
                            <div class="activity-description ms-2">
                                <p class="mb-0 rz-secondary-color imit-font fw-400 fz-16"><?php echo ucfirst(getUserNameById($comment->user_id)); ?> commented on <?php echo ucfirst(getUserNameById($comment_answer->user_id)); ?>'s answer for <span class="imit-font rz-color fw-500"><?php echo wp_trim_words($post->post_title, 10, false); ?></span> <span class="created-at"><?php echo human_time_diff(strtotime($activity['date']), strtotime($start_date)); ?> ago</span></p>
                            </div>
                        </a>
                    </li>
                <?php
                ...
                ?>
                    <li>
                        <a href="<?php echo get_permalink($post_data->ID); ?>" class="activity-link d-flex flex-row justify-content-start align-items-start">
                            <div class="activity-image">
                                <img src="<?php echo getProfileImageById($discuss_vote->user_id); ?>" alt="" style="min-width: 42px;">
                            </div>
                            <div class="activity-description ms-2">
                                <p class="mb-0 rz-secondary-color imit-font fw-400 fz-16"><?php echo ucfirst(getUserNameById($discuss_vote->user_id));
                                                                                            if ($discuss_vote->like_type == 'up-like') {
                                                                                                echo ' upvoted ';
                                                                                            } else {
                                                                                                echo ' downvoted ';
                                                                                            }
                                                                                            echo ucfirst(getUserNameById($post_data->post_author)); ?>'s post <span class="imit-font rz-color fw-500"><?php echo wp_trim_words($post_data->post_title, 10, false); ?></span> <span class="created-at"><?php echo human_time_diff(strtotime($discuss_vote->created_at), strtotime($start_date)); ?> ago</span></p>
                            </div>
                        </a>
                    </li>
                <?php
