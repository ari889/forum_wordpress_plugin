...
add_shortcode('imit-user-profile', function () {
    ...
    if (isset($ref) && is_user_logged_in() == false) {
?>
        <script>
        ...
        <div class="rz-mid">
            <div class="row mx-2 mx-lg-0">
                    ...
                    <div class="card rz-border rz-br mt-3">
                        <div class="card-body rz-border rz-br">
                            <div class="profile-data">
                                ...
                                <h3 class="name m-0 mt-3 text-center imit-font mb-1" id="name<?php echo $user_id; ?>"><?php echo getUserNameById($user_id); ?></h3>
                                <?php
                                ...
                                ?>
                                    <a href="#" class="btn follow rz-bg-color d-block text-center imit-font fz-14 text-white w-sm-50 w-100 me-sm-1 me-0 <?php echo ((is_user_logged_in() && count($get_all_followers) > 0) ? 'following' : ''); ?>" <?php echo ((is_user_logged_in()) ? 'id="rz-follow" data-receiver_id="' . $receiver_id . '"' : 'data-bs-toggle="modal" data-bs-target="#login-modal"'); ?>><?php echo ((is_user_logged_in() && count($get_all_followers) > 0) ? '<i class="fas fa-check-square me-2"></i>Following' : '<i class="fas fa-plus-circle me-2"></i>Follow'); ?></a>
                                    <a href="#" class="btn message d-block text-center mt-2 imit-font fz-14" <?php echo ((is_user_logged_in()) ? 'data-user_id="' . $receiver_id . '" id="send-message-button"' : 'data-bs-toggle="modal" data-bs-target="#login-modal"'); ?> style="line-height: 18px;font-weight: 700;"><i class="fas fa-comments me-2"></i>Message</a>
                                <?php
                                } else {
                                ?>
                                    <a href="#" class="follow d-block text-center mt-2 imit-font fz-14 text-white" style="line-height: 18px;font-weight: 700;" data-bs-toggle="modal" data-bs-target="#rz-profile-edit-modal"><i class="fas fa-pen me-2"></i>Edit Profile</a>
                                    <a href="#" class="message d-block text-center mt-2 imit-font fz-14 tab-link" style="line-height: 18px;font-weight: 700;" data-target="user-dairy">Scratch Pad</a>
                                <?php
                                }
                                ?>
                            </div>
                            ...
                            <ul class="about mb-0 ps-0 mt-3 pt-3">
                                ...
                                <li class="about-list rz-secondary-color list-unstyled my-2">
                                    ...
                                    <span class="imit-font fz-14">Joined <strong class="rz-color"><?php echo date('F, Y', strtotime($user_data->user_registered)); ?></strong></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-lg-9">
                        ...
                        <div class="d-flex flex-row justify-content-between align-items-center">
                            <ul class="tab-menu ps-0 mb-0 d-flex flex-row justify-content-start align-items-center">
                                <li class="tab-list list-unstyled">
                                    <a href="#" class="tab-link text-decoration-none me-3 pt-3 pb-2 d-block imit-font text-white fz-14 <?php echo (empty($ref)) ? 'active' : ''; ?>" data-target="rz-profile-user-answers">Answers</a>
                                </li>
                                <li class="tab-list list-unstyled">
                                    <a href="#" class="tab-link text-decoration-none me-3 pt-3 pb-2 d-block imit-font text-white fz-14" data-target="profile-feed">
                                        <div class="d-flex flex-row justify-content-between align-items-center"><span class="me-1">Question</span><span>Asked</span></div>
                                    </a>
                                </li>
                                <li class="tab-list list-unstyled">
                                    <a href="#" class="tab-link text-decoration-none me-3 pt-3 pb-2 d-block imit-font text-white fz-14" data-target="rz-profile-user-vote">
                                        <div class="d-flex flex-row justify-content-between align-items-center"><span class="me-1">Question</span><span>Voted</span></div>
                                    </a>
                                </li>
                                <li class="tab-list list-unstyled">
                                    <a href="#" class="tab-link text-decoration-none me-3 pt-3 pb-2 d-block imit-font text-white fz-14" data-target="rz-profile-user-comment">
                                        <div class="d-flex flex-row justify-content-between align-items-center"><span class="me-1">Question</span><span>commented</span></div>
                                    </a>
                                </li>
                                ...
                                if ((is_user_logged_in() == false || get_current_user_id() != um_profile_id()) && $dairy_data->have_posts() == true) {
                                ?>
                                    <li class="tab-list list-unstyled">
                                ...
                                ?>
                                    <li class="tab-list list-unstyled"><a class="tab-link text-decoration-none me-3 pt-3 pb-2 imit-font text-white fz-14 d-flex flex-row justify-content-between align-items-center <?php echo ((is_user_logged_in()) ? 'tab-link' : ''); ?> <?php echo ($ref == 'partner-program') ? 'active' : ''; ?>" href="#" data-target="partner-program"><span class="me-1">Join</span> <span class="me-1">partner</span> <span>program</span></a></li>
                                    <li class="tab-list list-unstyled"><a class="tab-link text-decoration-none me-3 pt-3 pb-2 imit-font text-white fz-14 d-flex flex-row justify-content-between align-items-center <?php echo ((is_user_logged_in()) ? 'tab-link' : ''); ?>" href="#" data-target="user-points"><span class="me-1">Points</span> <span>earned</span></a></li>
                                    <li class="tab-list list-unstyled"><a class="tab-link text-decoration-none me-3 pt-3 pb-2 imit-font text-white fz-14 d-flex flex-row justify-content-between align-items-center <?php echo ((is_user_logged_in()) ? 'tab-link' : ''); ?>" href="#" data-target="redeem-points"><span class="me-1">Redeem</span> <span>Points</span></a></li>
                                    <li class="tab-list list-unstyled"><a class="tab-link text-decoration-none me-3 pt-3 pb-2 imit-font text-white fz-14 d-flex flex-row justify-content-between align-items-center" href="#" data-target="change-password"><span class="me-1">Change</span> <span>Password</span></a></li>
                                <?php
                                }
                                ?>

                                <li class="tab-list list-unstyled"><a class="tab-link text-decoration-none me-3 pt-3 pb-2 d-block imit-font text-white fz-14" href="#" data-target="following-question">Following</a></li>
                                <?php if (is_user_logged_in() && um_profile_id() == get_current_user_id()) {
                                ?>
                                    <li class="tab-list list-unstyled"><a class="tab-link text-decoration-none me-3 pt-3 pb-2 d-block imit-font text-white fz-14" href="<?php echo site_url(); ?>/message">Message</a></li>
                                <?php
                                } ?>
                            </ul>
                            ...
                            <div class="dropdown custom-dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="feed-more-tabs">
                                    <li class="imit-dropdown-tabs">
                                        <a href="#" class="dropdown-item imit-font fz-14 tab-link <?php echo (empty($ref)) ? 'active' : ''; ?>" data-target="rz-profile-user-answers">Answers</a>
                                    </li>
                                    <li class="imit-dropdown-tabs">
                                        <a href="#" class="dropdown-item imit-font fz-14 tab-link" data-target="profile-feed">Question Asked</a>
                                    </li>
                                    <li class="imit-dropdown-tabs">
                                        <a href="#" class="dropdown-item imit-font fz-14 tab-link" data-target="rz-profile-user-vote">Question Voted</a>
                                    </li>
                                    <li class="imit-dropdown-tabs">
                                        <a href="#" class="dropdown-item imit-font fz-14 tab-link" data-target="rz-profile-user-comment">Question commented</a>
                                    </li>
                                    <?php
                                    if (is_user_logged_in() && get_current_user_id() == um_profile_id()) {
                                    ?>
                                        <li class="imit-dropdown-tabs"><a class="dropdown-item imit-font fz-14 <?php echo ((is_user_logged_in()) ? 'tab-link' : ''); ?> <?php echo ($ref == 'partner-program') ? 'active' : ''; ?>" href="#" data-target="partner-program">Join partner program</a></li>
                                        <li class="imit-dropdown-tabs"><a class="<?php echo ((is_user_logged_in()) ? 'tab-link' : ''); ?> dropdown-item imit-font fz-14" href="#" data-target="user-points">Points earned</a></li>
                                        <li class="imit-dropdown-tabs"><a class="dropdown-item imit-font fz-14 <?php echo ((is_user_logged_in()) ? 'tab-link' : ''); ?>" href="#" data-target="redeem-points">Redeem Points</a></li>
                                        <li class="imit-dropdown-tabs"><a class="dropdown-item imit-font fz-14 tab-link" href="#" data-target="change-password">Change Password</a></li>
                                    <?php
                                    }
                                    ?>

                                    <li class="imit-dropdown-tabs"><a class="tab-link dropdown-item imit-font fz-14" href="#" data-target="following-question">Following</a></li>
                                    <?php if (is_user_logged_in() && um_profile_id() == get_current_user_id()) {
                                    ?>
                                        <li class="imit-dropdown-tabs"><a class="dropdown-item imit-font fz-14" href="<?php echo site_url(); ?>/message">Message</a></li>
                                    <?php
                                    } ?>
                                </ul>
                            </div>
                    ...
                    <div class="tab-content" id="rz-profile-user-answers" style="<?php echo (empty($ref)) ? 'display: block;' : 'display: none;'; ?>">
                        ...
                        <div class="tab-content" id="change-password" style="display: none;">
                            <div class="card rz-border rz-br mt-3 programme">
                                <div class="card-header rz-br py-3 rz-light-bg p-3">
                                    <h3 class="m-0 title rz-color fw-500">Change Password</h3>
                                </div>
                                <div class="card-body">
                                    <p class="imit-font fz-16 rz-secondary-color">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laborum quis minima veritatis accusamus? Dolor provident qui vero aperiam pariatur ipsam!</p>
                                    <form id="change_password_form">
                                        <div id="change_password_error"></div>
                                        <label for="old_password" class="form-label init-font">Old Password</label>
                                        <input type="password" id="old_password" name="old-password" class="form-control fz-16 rz-border mt-2" placeholder="*****************">

                                        <label for="new_password" class="form-label mt-3 fz-16 init-font">New Password</label>
                                        <input type="password" id="new_password" name="new-password" class="form-control fz-16 rz-border mt-2" placeholder="*****************">

                                        <label for="confirm_password" class="form-label mt-3 fz-16 init-font">Confirm Password</label>
                                        <input type="password" id="confirm_password" name="confirm-password" class="form-control fz-16 rz-border mt-2" placeholder="*****************">

                                        <div class="form-check mt-3">
                                            <input class="form-check-input" name="logged-in" type="checkbox" value="yes" id="change-password-logged-in" checked>
                                            <label class="form-check-label imit-font fz-16" for="change-password-logged-in">
                                                Keep me logged in
                                            </label>
                                        </div>


                                        <button type="submit" class="btn rz-bg-color text-white imit-font fz-14 mt-3 d-table ms-auto">Save</button>
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-content" id="following" style="display: none;">
                        ...
                        <div id="following-users" class="following-content" style="display: none;">
                            <ul class="ps-0 mb-0 row" id="following-users-ul">

                            </ul>
                        </div>
                        <!-- following end start -->
                    </div>
                    <div class="tab-content" id="user-dairy" style="<?php echo ((isset($ref) && $ref == 'dairy') ? 'display: block;' : 'display: none;') ?>">
                        <?php if (is_user_logged_in() && get_current_user_id() == um_profile_id()) {
                        ?>
                    ...
                    <?php if (is_user_logged_in() && get_current_user_id() == um_profile_id()) {
                    ?>
                        <div class="tab-content" id="partner-program" style="<?php echo (isset($ref) && $ref == 'partner-program') ? 'display: block;' : 'display: none;'; ?>">
                            <div class="card rz-border rz-br mt-3 programme">
                                <div class="card-header rz-br py-3 rz-light-bg p-3">
                                    <h3 class="m-0 title rz-color fw-500">Join Partner Program</h3>
                                </div>
                                <div class="card-body">
                                    <?php if (!count($is_user_requested) > 0 || $is_user_requested[0]['status'] == '2') {
                                    ?>
                                        <form id="join-partner-program">
                                            ...
                                            <p class="imit-font rz-secondary-color fz-14 mt-2">Read our <a href="#partner-programme-guide" class="rz-color fw-500">Guidlines</a> for Partner Program</p>
                                        ...
                                        <?php } else {
                                        if ($is_user_requested[0]['status'] == '1') {
                                        ?>
                                            <p class="imit-font fz-14 rz-secondary-color description mb-0">You are already a partner of our program.</p>
                                        <?php
                                        } else {
                                        ?>
                                            <p class="imit-font fz-14 rz-secondary-color description mb-0">Your joining request is under consideration and you will be informed soon about it.</p>
                                    <?php
                                        }
                                    } ?>
                                </div>
                            </div>
                            <div class="card rz-border rz-br mt-3 programme" id="partner-programme-guide">
                    ...
                    ?>
                        <div class="tab-content" id="user-points" style="display: none;">
                            <div class="card rz-border mt-3 rz-br">
                                ...
                                <div class="card-body">
                                    <ul class="point-list d-flex flex-md-row flex-column justify-content-between align-content-center p-0 m-0">

                                        <?php
                                        $current_user = get_current_user_id();
                                        $get_point_list = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}rz_point_table WHERE user_id = '{$current_user}' ORDER BY id DESC LIMIT 0, 10", ARRAY_A);
                                        ...
                                        ?>
                                        <li class="point-list-item rounded py-3 px-3 bg-light text-center list-unstyled w-100">
                                        ...
                                        <li class="point-list-item rounded py-3 px-3 bg-light text-center list-unstyled mx-md-3 mx-0 my-md-0 my-3 w-100">
                                        ...
                                        <li class="point-list-item rounded py-3 px-3 bg-light text-center list-unstyled w-100">
                                            <p class="mb-0 rz-color imit-font rz-color fw-500"><?php if (!empty($user_profile_data)) {
                                                                                                    echo $user_profile_data->points;
                                                                                                } else {
                                                                                                    echo 0;
                                                                                                }; ?></p>
                                    ...
                                    <div class="points-history bg-light p-3 mt-3 rounded">
                                        ...
                                        <p class="imit-font text-dark fw-500 mb-0" style="font-size: 18px;">Your Activity</p>
                                        <ul class="point-history-list p-0 m-0" id="points-earned-data">
                                            <?php
                                            foreach ($get_point_list as $point) {
                                            ...
                                            ?>
                                            <li id="load-more-point"></li>
                                            <div id="point-loader" style="display: none;">
                            ...
                            <div class="card rz-border mt-3 rz-br">
                                ...
                                <div class="card-body redeem-points-body p-4">
                                    <form id="redeem-point-form">
                                        ...
                                        <p class="imit-font fz-16 text-dark">Points Outstanding : <span class="rz-color fw-500"><?php if (!empty($user_profile_data)) {
                                                                                                                                    echo $user_profile_data->points;
                                                                                                                                } else {
                                                                                                                                    echo 0;
                                                                                                                                }; ?></span></p>
                                        ...
                                        <div class="d-block">
                                            <div class="radio-button d-inline-block">
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-body p-4">
                        <button type="button" class="btn-close d-block ms-auto bg-transparent border-0" data-bs-dismiss="modal" aria-label="Close"></button>
                        <div class="profile-image mx-auto mb-4">
                            <img id="profile_image_show_modal" src="<?php echo getProfileImageById(get_current_user_id(), 'full'); ?>" alt="">
                        ...
                        <form id="update-rz-user-profile">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="first_name" class="imit-font fw-500 text-dark fz-16">First Name <span class="text-danger">*</span></label>
                                    <input name="first_name" type="text" id="first_name" class="form-control imit-font fz-14 text-dark mt-1 rz-border" placeholder="" value="<?php echo $user_data->user_firstname; ?>">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="last_name" class="imit-font fw-500 text-dark fz-16">Last name <span class="text-danger">*</span></label>
                                    <input name="last_name" type="text" id="last_name" class="form-control imit-font fz-14 text-dark mt-1 rz-border" placeholder="" value="<?php echo $user_data->user_lastname; ?>">
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="bio" class="imit-font fw-500 text-dark fz-16">Occupation / Bio</label>
                                    <input name="bio" type="text" id="bio" class="form-control imit-font fz-14 text-dark mt-1 rz-border" placeholder="e.g. Software Engineer" value="<?php echo $profile_data_modal->occupation; ?>">
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="email" class="imit-font fw-500 text-dark fz-16">Email <span class="text-danger">*</span></label>
                                    <input type="text" id="email" class="form-control imit-font fz-14 text-dark mt-1 rz-border" placeholder="" value="<?php echo $user_data->user_email; ?>" disabled>
                                </div>
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="input-group mt-1">
                                        ...
                                        <input name="cell" type="text" class="form-control imit-font fz-14 text-dark rz-border" placeholder="" aria-label="Username" aria-describedby="basic-addon1" value="<?php echo $profile_data_modal->phone_number; ?>">
                                    </div>
                                </div>
                                <div class="col-12 mb-3">
                                    <div class="form-check">
                                        <input name="whatsapp_alert" class="form-check-input" type="checkbox" id="rz-alert" value="yes" <?php if ($profile_data_modal->whatsapp_alert == 'yes') {
                                                                                                                                            echo 'checked';
                                                                                                                                        } ?>>
                                ...
                                <div class="col-12 mb-3">
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <label for="location" class="imit-font fw-500 text-dark fz-16 mb-2">Select Country</label>
                                            <select id="country" name="country" class="form-select rz-border imit-font fz-14">
                                                <option>--Select Country--</option>
                                                <option value="Afganistan" <?php if ($profile_data_modal->country == 'Afganistan') {
                                                                                echo 'selected';
                                                                            } ?>>Afghanistan</option>
                                                <option value="Albania" <?php if ($profile_data_modal->country == 'Albania') {
                                                                            echo 'selected';
                                                                        } ?>>Albania</option>
                                                <option value="Algeria" <?php if ($profile_data_modal->country == 'Algeria') {
                                                                            echo 'selected';
                                                                        } ?>>Algeria</option>
                                                <option value="American Samoa" <?php if ($profile_data_modal->country == 'American Samoa') {
                                                                                    echo 'selected';
                                                                                } ?>>American Samoa</option>
                                                <option value="Andorra" <?php if ($profile_data_modal->country == 'Andorra') {
                                                                            echo 'selected';
                                                                        } ?>>Andorra</option>
                                                <option value="Angola" <?php if ($profile_data_modal->country == 'Angola') {
                                                                            echo 'selected';
                                                                        } ?>>Angola</option>
                                                <option value="Anguilla" <?php if ($profile_data_modal->country == 'Anguilla') {
                                                                                echo 'selected';
                                                                            } ?>>Anguilla</option>
                                                <option value="Antigua & Barbuda" <?php if ($profile_data_modal->country == 'Antigua & Barbuda') {
                                                                                        echo 'selected';
                                                                                    } ?>>Antigua & Barbuda</option>
                                                <option value="Argentina" <?php if ($profile_data_modal->country == 'Argentina') {
                                                                                echo 'selected';
                                                                            } ?>>Argentina</option>
                                                <option value="Armenia" <?php if ($profile_data_modal->country == 'Armenia') {
                                                                            echo 'selected';
                                                                        } ?>>Armenia</option>
                                                <option value="Aruba" <?php if ($profile_data_modal->country == 'Aruba') {
                                                                            echo 'selected';
                                                                        } ?>>Aruba</option>
                                                <option value="Australia" <?php if ($profile_data_modal->country == 'Australia') {
                                                                                echo 'selected';
                                                                            } ?>>Australia</option>
                                                <option value="Austria" <?php if ($profile_data_modal->country == 'Austria') {
                                                                            echo 'selected';
                                                                        } ?>>Austria</option>
                                                <option value="Azerbaijan" <?php if ($profile_data_modal->country == 'Azerbaijan') {
                                                                                echo 'selected';
                                                                            } ?>>Azerbaijan</option>
                                                <option value="Bahamas" <?php if ($profile_data_modal->country == 'Bahamas') {
                                                                            echo 'selected';
                                                                        } ?>>Bahamas</option>
                                                <option value="Bahrain" <?php if ($profile_data_modal->country == 'Bahrain') {
                                                                            echo 'selected';
                                                                        } ?>>Bahrain</option>
                                                <option value="Bangladesh" <?php if ($profile_data_modal->country == 'Bangladesh') {
                                                                                echo 'selected';
                                                                            } ?>>Bangladesh</option>
                                                <option value="Barbados" <?php if ($profile_data_modal->country == 'Barbados') {
                                                                                echo 'selected';
                                                                            } ?>>Barbados</option>
                                                <option value="Belarus" <?php if ($profile_data_modal->country == 'Belarus') {
                                                                            echo 'selected';
                                                                        } ?>>Belarus</option>
                                                <option value="Belgium" <?php if ($profile_data_modal->country == 'Belgium') {
                                                                            echo 'selected';
                                                                        } ?>>Belgium</option>
                                                <option value="Belize" <?php if ($profile_data_modal->country == 'Benin') {
                                                                            echo 'selected';
                                                                        } ?>>Belize</option>
                                                <option value="Benin" <?php if ($profile_data_modal->country == 'American Samoa') {
                                                                            echo 'selected';
                                                                        } ?>>Benin</option>
                                                <option value="Bermuda" <?php if ($profile_data_modal->country == 'Bermuda') {
                                                                            echo 'selected';
                                                                        } ?>>Bermuda</option>
                                                <option value="Bhutan" <?php if ($profile_data_modal->country == 'Bhutan') {
                                                                            echo 'selected';
                                                                        } ?>>Bhutan</option>
                                                <option value="Bolivia" <?php if ($profile_data_modal->country == 'Bolivia') {
                                                                            echo 'selected';
                                                                        } ?>>Bolivia</option>
                                                <option value="Bonaire" <?php if ($profile_data_modal->country == 'Bonaire') {
                                                                            echo 'selected';
                                                                        } ?>>Bonaire</option>
                                                <option value="Bosnia & Herzegovina" <?php if ($profile_data_modal->country == 'Bosnia & Herzegovina') {
                                                                                            echo 'selected';
                                                                                        } ?>>Bosnia & Herzegovina</option>
                                                <option value="Botswana" <?php if ($profile_data_modal->country == 'Botswana') {
                                                                                echo 'selected';
                                                                            } ?>>Botswana</option>
                                                <option value="Brazil" <?php if ($profile_data_modal->country == 'Brazil') {
                                                                            echo 'selected';
                                                                        } ?>>Brazil</option>
                                                <option value="British Indian Ocean Ter" <?php if ($profile_data_modal->country == 'British Indian Ocean Ter') {
                                                                                                echo 'selected';
                                                                                            } ?>>British Indian Ocean Ter</option>
                                                <option value="Brunei" <?php if ($profile_data_modal->country == 'Brunei') {
                                                                            echo 'selected';
                                                                        } ?>>Brunei</option>
                                                <option value="Bulgaria" <?php if ($profile_data_modal->country == 'Bulgaria') {
                                                                                echo 'selected';
                                                                            } ?>>Bulgaria</option>
                                                <option value="Burkina Faso" <?php if ($profile_data_modal->country == 'Burkina Faso') {
                                                                                    echo 'selected';
                                                                                } ?>>Burkina Faso</option>
                                                <option value="Burundi" <?php if ($profile_data_modal->country == 'Burundi') {
                                                                            echo 'selected';
                                                                        } ?>>Burundi</option>
                                                <option value="Cambodia" <?php if ($profile_data_modal->country == 'Cambodia') {
                                                                                echo 'selected';
                                                                            } ?>>Cambodia</option>
                                                <option value="Cameroon" <?php if ($profile_data_modal->country == 'Cameroon') {
                                                                                echo 'selected';
                                                                            } ?>>Cameroon</option>
                                                <option value="Canada" <?php if ($profile_data_modal->country == 'Canada') {
                                                                            echo 'selected';
                                                                        } ?>>Canada</option>
                                                <option value="Canary Islands" <?php if ($profile_data_modal->country == 'Canary Islands') {
                                                                                    echo 'selected';
                                                                                } ?>>Canary Islands</option>
                                                <option value="Cape Verde" <?php if ($profile_data_modal->country == 'Cape Verde') {
                                                                                echo 'selected';
                                                                            } ?>>Cape Verde</option>
                                                <option value="Cayman Islands" <?php if ($profile_data_modal->country == 'Cayman Islands') {
                                                                                    echo 'selected';
                                                                                } ?>>Cayman Islands</option>
                                                <option value="Central African Republic" <?php if ($profile_data_modal->country == 'Central African Republic') {
                                                                                                echo 'selected';
                                                                                            } ?>>Central African Republic</option>
                                                <option value="Chad" <?php if ($profile_data_modal->country == 'Chad') {
                                                                            echo 'selected';
                                                                        } ?>>Chad</option>
                                                <option value="Channel Islands" <?php if ($profile_data_modal->country == 'Channel Islands') {
                                                                                    echo 'selected';
                                                                                } ?>>Channel Islands</option>
                                                <option value="Chile" <?php if ($profile_data_modal->country == 'Chile') {
                                                                            echo 'selected';
                                                                        } ?>>Chile</option>
                                                <option value="China" <?php if ($profile_data_modal->country == 'China') {
                                                                            echo 'selected';
                                                                        } ?>>China</option>
                                                <option value="Christmas Island" <?php if ($profile_data_modal->country == 'Christmas Island') {
                                                                                        echo 'selected';
                                                                                    } ?>>Christmas Island</option>
                                                <option value="Cocos Island" <?php if ($profile_data_modal->country == 'Cocos Island') {
                                                                                    echo 'selected';
                                                                                } ?>>Cocos Island</option>
                                                <option value="Colombia" <?php if ($profile_data_modal->country == 'Colombia') {
                                                                                echo 'selected';
                                                                            } ?>>Colombia</option>
                                                <option value="Comoros" <?php if ($profile_data_modal->country == 'Comoros') {
                                                                            echo 'selected';
                                                                        } ?>>Comoros</option>
                                                <option value="Congo" <?php if ($profile_data_modal->country == 'Congo') {
                                                                            echo 'selected';
                                                                        } ?>>Congo</option>
                                                <option value="Cook Islands" <?php if ($profile_data_modal->country == 'Cook Islands') {
                                                                                    echo 'selected';
                                                                                } ?>>Cook Islands</option>
                                                <option value="Costa Rica" <?php if ($profile_data_modal->country == 'Costa Rica') {
                                                                                echo 'selected';
                                                                            } ?>>Costa Rica</option>
                                                <option value="Cote DIvoire" <?php if ($profile_data_modal->country == 'Cote DIvoire') {
                                                                                    echo 'selected';
                                                                                } ?>>Cote DIvoire</option>
                                                <option value="Croatia" <?php if ($profile_data_modal->country == 'Croatia') {
                                                                            echo 'selected';
                                                                        } ?>>Croatia</option>
                                                <option value="Cuba" <?php if ($profile_data_modal->country == 'Cuba') {
                                                                            echo 'selected';
                                                                        } ?>>Cuba</option>
                                                <option value="Curaco" <?php if ($profile_data_modal->country == 'Curaco') {
                                                                            echo 'selected';
                                                                        } ?>>Curacao</option>
                                                <option value="Cyprus" <?php if ($profile_data_modal->country == 'Cyprus') {
                                                                            echo 'selected';
                                                                        } ?>>Cyprus</option>
                                                <option value="Czech Republic" <?php if ($profile_data_modal->country == 'Czech Republic') {
                                                                                    echo 'selected';
                                                                                } ?>>Czech Republic</option>
                                                <option value="Denmark" <?php if ($profile_data_modal->country == 'Denmark') {
                                                                            echo 'selected';
                                                                        } ?>>Denmark</option>
                                                <option value="Djibouti" <?php if ($profile_data_modal->country == 'Djibouti') {
                                                                                echo 'selected';
                                                                            } ?>>Djibouti</option>
                                                <option value="Dominica" <?php if ($profile_data_modal->country == 'Dominica') {
                                                                                echo 'selected';
                                                                            } ?>>Dominica</option>
                                                <option value="Dominican Republic" <?php if ($profile_data_modal->country == 'Dominican Republic') {
                                                                                        echo 'selected';
                                                                                    } ?>>Dominican Republic</option>
                                                <option value="East Timor" <?php if ($profile_data_modal->country == 'East Timor') {
                                                                                echo 'selected';
                                                                            } ?>>East Timor</option>
                                                <option value="Ecuador" <?php if ($profile_data_modal->country == 'Ecuador') {
                                                                            echo 'selected';
                                                                        } ?>>Ecuador</option>
                                                <option value="Egypt" <?php if ($profile_data_modal->country == 'Egypt') {
                                                                            echo 'selected';
                                                                        } ?>>Egypt</option>
                                                <option value="El Salvador" <?php if ($profile_data_modal->country == 'El Salvador') {
                                                                                echo 'selected';
                                                                            } ?>>El Salvador</option>
                                                <option value="Equatorial Guinea" <?php if ($profile_data_modal->country == 'Equatorial Guinea') {
                                                                                        echo 'selected';
                                                                                    } ?>>Equatorial Guinea</option>
                                                <option value="Eritrea" <?php if ($profile_data_modal->country == 'Eritrea') {
                                                                            echo 'selected';
                                                                        } ?>>Eritrea</option>
                                                <option value="Estonia" <?php if ($profile_data_modal->country == 'Estonia') {
                                                                            echo 'selected';
                                                                        } ?>>Estonia</option>
                                                <option value="Ethiopia" <?php if ($profile_data_modal->country == 'Ethiopia') {
                                                                                echo 'selected';
                                                                            } ?>>Ethiopia</option>
                                                <option value="Falkland Islands" <?php if ($profile_data_modal->country == 'Falkland Islands') {
                                                                                        echo 'selected';
                                                                                    } ?>>Falkland Islands</option>
                                                <option value="Faroe Islands" <?php if ($profile_data_modal->country == 'Faroe Islands') {
                                                                                    echo 'selected';
                                                                                } ?>>Faroe Islands</option>
                                                <option value="Fiji" <?php if ($profile_data_modal->country == 'Fiji') {
                                                                            echo 'selected';
                                                                        } ?>>Fiji</option>
                                                <option value="Finland" <?php if ($profile_data_modal->country == 'Finland') {
                                                                            echo 'selected';
                                                                        } ?>>Finland</option>
                                                <option value="France" <?php if ($profile_data_modal->country == 'France') {
                                                                            echo 'selected';
                                                                        } ?>>France</option>
                                                <option value="French Guiana" <?php if ($profile_data_modal->country == 'French Polynesia') {
                                                                                    echo 'selected';
                                                                                } ?>>French Guiana</option>
                                                <option value="French Polynesia" <?php if ($profile_data_modal->country == 'American Samoa') {
                                                                                        echo 'selected';
                                                                                    } ?>>French Polynesia</option>
                                                <option value="French Southern Ter" <?php if ($profile_data_modal->country == 'French Southern Ter') {
                                                                                        echo 'selected';
                                                                                    } ?>>French Southern Ter</option>
                                                <option value="Gabon" <?php if ($profile_data_modal->country == 'Gabon') {
                                                                            echo 'selected';
                                                                        } ?>>Gabon</option>
                                                <option value="Gambia" <?php if ($profile_data_modal->country == 'Gambia') {
                                                                            echo 'selected';
                                                                        } ?>>Gambia</option>
                                                <option value="Georgia" <?php if ($profile_data_modal->country == 'Georgia') {
                                                                            echo 'selected';
                                                                        } ?>>Georgia</option>
                                                <option value="Germany" <?php if ($profile_data_modal->country == 'Germany') {
                                                                            echo 'selected';
                                                                        } ?>>Germany</option>
                                                <option value="Ghana" <?php if ($profile_data_modal->country == 'Ghana') {
                                                                            echo 'selected';
                                                                        } ?>>Ghana</option>
                                                <option value="Gibraltar" <?php if ($profile_data_modal->country == 'Gibraltar') {
                                                                                echo 'selected';
                                                                            } ?>>Gibraltar</option>
                                                <option value="Great Britain" <?php if ($profile_data_modal->country == 'Great Britain') {
                                                                                    echo 'selected';
                                                                                } ?>>Great Britain</option>
                                                <option value="Greece" <?php if ($profile_data_modal->country == 'Greece') {
                                                                            echo 'selected';
                                                                        } ?>>Greece</option>
                                                <option value="Greenland" <?php if ($profile_data_modal->country == 'Greenland') {
                                                                                echo 'selected';
                                                                            } ?>>Greenland</option>
                                                <option value="Grenada" <?php if ($profile_data_modal->country == 'Grenada') {
                                                                            echo 'selected';
                                                                        } ?>>Grenada</option>
                                                <option value="Guadeloupe" <?php if ($profile_data_modal->country == 'Guadeloupe') {
                                                                                echo 'selected';
                                                                            } ?>>Guadeloupe</option>
                                                <option value="Guam" <?php if ($profile_data_modal->country == 'Guam') {
                                                                            echo 'selected';
                                                                        } ?>>Guam</option>
                                                <option value="Guatemala" <?php if ($profile_data_modal->country == 'Guatemala') {
                                                                                echo 'selected';
                                                                            } ?>>Guatemala</option>
                                                <option value="Guinea" <?php if ($profile_data_modal->country == 'Guinea') {
                                                                            echo 'selected';
                                                                        } ?>>Guinea</option>
                                                <option value="Guyana" <?php if ($profile_data_modal->country == 'Guyana') {
                                                                            echo 'selected';
                                                                        } ?>>Guyana</option>
                                                <option value="Haiti" <?php if ($profile_data_modal->country == 'Haiti') {
                                                                            echo 'selected';
                                                                        } ?>>Haiti</option>
                                                <option value="Hawaii" <?php if ($profile_data_modal->country == 'Hawaii') {
                                                                            echo 'selected';
                                                                        } ?>>Hawaii</option>
                                                <option value="Honduras" <?php if ($profile_data_modal->country == 'Honduras') {
                                                                                echo 'selected';
                                                                            } ?>>Honduras</option>
                                                <option value="Hong Kong" <?php if ($profile_data_modal->country == 'Hong Kong') {
                                                                                echo 'selected';
                                                                            } ?>>Hong Kong</option>
                                                <option value="Hungary" <?php if ($profile_data_modal->country == 'Hungary') {
                                                                            echo 'selected';
                                                                        } ?>>Hungary</option>
                                                <option value="Iceland" <?php if ($profile_data_modal->country == 'Iceland') {
                                                                            echo 'selected';
                                                                        } ?>>Iceland</option>
                                                <option value="Indonesia" <?php if ($profile_data_modal->country == 'Indonesia') {
                                                                                echo 'selected';
                                                                            } ?>>Indonesia</option>
                                                <option value="India" <?php if ($profile_data_modal->country == 'India') {
                                                                            echo 'selected';
                                                                        } ?>>India</option>
                                                <option value="Iran" <?php if ($profile_data_modal->country == 'Iran') {
                                                                            echo 'selected';
                                                                        } ?>>Iran</option>
                                                <option value="Iraq" <?php if ($profile_data_modal->country == 'Iraq') {
                                                                            echo 'selected';
                                                                        } ?>>Iraq</option>
                                                <option value="Ireland" <?php if ($profile_data_modal->country == 'Ireland') {
                                                                            echo 'selected';
                                                                        } ?>>Ireland</option>
                                                <option value="Isle of Man" <?php if ($profile_data_modal->country == 'Isle of Man') {
                                                                                echo 'selected';
                                                                            } ?>>Isle of Man</option>
                                                <option value="Israel" <?php if ($profile_data_modal->country == 'Israel') {
                                                                            echo 'selected';
                                                                        } ?>>Israel</option>
                                                <option value="Italy" <?php if ($profile_data_modal->country == 'Italy') {
                                                                            echo 'selected';
                                                                        } ?>>Italy</option>
                                                <option value="Jamaica" <?php if ($profile_data_modal->country == 'Jamaica') {
                                                                            echo 'selected';
                                                                        } ?>>Jamaica</option>
                                                <option value="Japan" <?php if ($profile_data_modal->country == 'Japan') {
                                                                            echo 'selected';
                                                                        } ?>>Japan</option>
                                                <option value="Jordan" <?php if ($profile_data_modal->country == 'Jordan') {
                                                                            echo 'selected';
                                                                        } ?>>Jordan</option>
                                                <option value="Kazakhstan" <?php if ($profile_data_modal->country == 'Kazakhstan') {
                                                                                echo 'selected';
                                                                            } ?>>Kazakhstan</option>
                                                <option value="Kenya" <?php if ($profile_data_modal->country == 'Kenya') {
                                                                            echo 'selected';
                                                                        } ?>>Kenya</option>
                                                <option value="Kiribati" <?php if ($profile_data_modal->country == 'Kiribati') {
                                                                                echo 'selected';
                                                                            } ?>>Kiribati</option>
                                                <option value="Korea North" <?php if ($profile_data_modal->country == 'Korea North') {
                                                                                echo 'selected';
                                                                            } ?>>Korea North</option>
                                                <option value="Korea Sout" <?php if ($profile_data_modal->country == 'Korea Sout') {
                                                                                echo 'selected';
                                                                            } ?>>Korea South</option>
                                                <option value="Kuwait" <?php if ($profile_data_modal->country == 'Kuwait') {
                                                                            echo 'selected';
                                                                        } ?>>Kuwait</option>
                                                <option value="Kyrgyzstan" <?php if ($profile_data_modal->country == 'Laos') {
                                                                                echo 'selected';
                                                                            } ?>>Kyrgyzstan</option>
                                                <option value="Laos" <?php if ($profile_data_modal->country == 'Laos') {
                                                                            echo 'selected';
                                                                        } ?>>Laos</option>
                                                <option value="Latvia" <?php if ($profile_data_modal->country == 'Latvia') {
                                                                            echo 'selected';
                                                                        } ?>>Latvia</option>
                                                <option value="Lebanon" <?php if ($profile_data_modal->country == 'Lebanon') {
                                                                            echo 'selected';
                                                                        } ?>>Lebanon</option>
                                                <option value="Lesotho" <?php if ($profile_data_modal->country == 'Lesotho') {
                                                                            echo 'selected';
                                                                        } ?>>Lesotho</option>
                                                <option value="Liberia" <?php if ($profile_data_modal->country == 'Liberia') {
                                                                            echo 'selected';
                                                                        } ?>>Liberia</option>
                                                <option value="Libya" <?php if ($profile_data_modal->country == 'Liechtenstein') {
                                                                            echo 'selected';
                                                                        } ?>>Libya</option>
                                                <option value="Liechtenstein" <?php if ($profile_data_modal->country == 'American Samoa') {
                                                                                    echo 'selected';
                                                                                } ?>>Liechtenstein</option>
                                                <option value="Lithuania" <?php if ($profile_data_modal->country == 'Lithuania') {
                                                                                echo 'selected';
                                                                            } ?>>Lithuania</option>
                                                <option value="Luxembourg" <?php if ($profile_data_modal->country == 'Luxembourg') {
                                                                                echo 'selected';
                                                                            } ?>>Luxembourg</option>
                                                <option value="Macau" <?php if ($profile_data_modal->country == 'Macau') {
                                                                            echo 'selected';
                                                                        } ?>>Macau</option>
                                                <option value="Macedonia" <?php if ($profile_data_modal->country == 'Macedonia') {
                                                                                echo 'selected';
                                                                            } ?>>Macedonia</option>
                                                <option value="Madagascar" <?php if ($profile_data_modal->country == 'Malaysia') {
                                                                                echo 'selected';
                                                                            } ?>>Madagascar</option>
                                                <option value="Malaysia" <?php if ($profile_data_modal->country == 'American Samoa') {
                                                                                echo 'selected';
                                                                            } ?>>Malaysia</option>
                                                <option value="Malawi" <?php if ($profile_data_modal->country == 'Malawi') {
                                                                            echo 'selected';
                                                                        } ?>>Malawi</option>
                                                <option value="Maldives" <?php if ($profile_data_modal->country == 'Maldives') {
                                                                                echo 'selected';
                                                                            } ?>>Maldives</option>
                                                <option value="Mali" <?php if ($profile_data_modal->country == 'American Samoa') {
                                                                            echo 'selected';
                                                                        } ?>>Mali</option>
                                                <option value="Malta" <?php if ($profile_data_modal->country == 'Malta') {
                                                                            echo 'selected';
                                                                        } ?>>Malta</option>
                                                <option value="Marshall Islands" <?php if ($profile_data_modal->country == 'Marshall Islands') {
                                                                                        echo 'selected';
                                                                                    } ?>>Marshall Islands</option>
                                                <option value="Martinique" <?php if ($profile_data_modal->country == 'Martinique') {
                                                                                echo 'selected';
                                                                            } ?>>Martinique</option>
                                                <option value="Mauritania" <?php if ($profile_data_modal->country == 'Mauritania') {
                                                                                echo 'selected';
                                                                            } ?>>Mauritania</option>
                                                <option value="Mauritius" <?php if ($profile_data_modal->country == 'Mauritius') {
                                                                                echo 'selected';
                                                                            } ?>>Mauritius</option>
                                                <option value="Mayotte" <?php if ($profile_data_modal->country == 'Mayotte') {
                                                                            echo 'selected';
                                                                        } ?>>Mayotte</option>
                                                <option value="Mexico" <?php if ($profile_data_modal->country == 'Mexico') {
                                                                            echo 'selected';
                                                                        } ?>>Mexico</option>
                                                <option value="Midway Islands" <?php if ($profile_data_modal->country == 'Midway Islands') {
                                                                                    echo 'selected';
                                                                                } ?>>Midway Islands</option>
                                                <option value="Moldova" <?php if ($profile_data_modal->country == 'Moldova') {
                                                                            echo 'selected';
                                                                        } ?>>Moldova</option>
                                                <option value="Monaco" <?php if ($profile_data_modal->country == 'Monaco') {
                                                                            echo 'selected';
                                                                        } ?>>Monaco</option>
                                                <option value="Mongolia" <?php if ($profile_data_modal->country == 'Mongolia') {
                                                                                echo 'selected';
                                                                            } ?>>Mongolia</option>
                                                <option value="Montserrat" <?php if ($profile_data_modal->country == 'Montserrat') {
                                                                                echo 'selected';
                                                                            } ?>>Montserrat</option>
                                                <option value="Morocco" <?php if ($profile_data_modal->country == 'Morocco') {
                                                                            echo 'selected';
                                                                        } ?>>Morocco</option>
                                                <option value="Mozambique" <?php if ($profile_data_modal->country == 'Mozambique') {
                                                                                echo 'selected';
                                                                            } ?>>Mozambique</option>
                                                <option value="Myanmar" <?php if ($profile_data_modal->country == 'Myanmar') {
                                                                            echo 'selected';
                                                                        } ?>>Myanmar</option>
                                                <option value="Nambia" <?php if ($profile_data_modal->country == 'Nambia') {
                                                                            echo 'selected';
                                                                        } ?>>Nambia</option>
                                                <option value="Nauru" <?php if ($profile_data_modal->country == 'Nauru') {
                                                                            echo 'selected';
                                                                        } ?>>Nauru</option>
                                                <option value="Nepal" <?php if ($profile_data_modal->country == 'Nepal') {
                                                                            echo 'selected';
                                                                        } ?>>Nepal</option>
                                                <option value="Netherland Antilles" <?php if ($profile_data_modal->country == 'Netherland Antilles') {
                                                                                        echo 'selected';
                                                                                    } ?>>Netherland Antilles</option>
                                                <option value="Netherlands" <?php if ($profile_data_modal->country == 'Netherlands') {
                                                                                echo 'selected';
                                                                            } ?>>Netherlands (Holland, Europe)</option>
                                                <option value="Nevis" <?php if ($profile_data_modal->country == 'Nevis') {
                                                                            echo 'selected';
                                                                        } ?>>Nevis</option>
                                                <option value="New Caledonia" <?php if ($profile_data_modal->country == 'New Caledonia') {
                                                                                    echo 'selected';
                                                                                } ?>>New Caledonia</option>
                                                <option value="New Zealand" <?php if ($profile_data_modal->country == 'New Zealand') {
                                                                                echo 'selected';
                                                                            } ?>>New Zealand</option>
                                                <option value="Nicaragua" <?php if ($profile_data_modal->country == 'Nicaragua') {
                                                                                echo 'selected';
                                                                            } ?>>Nicaragua</option>
                                                <option value="Niger" <?php if ($profile_data_modal->country == 'Niger') {
                                                                            echo 'selected';
                                                                        } ?>>Niger</option>
                                                <option value="Nigeria" <?php if ($profile_data_modal->country == 'Nigeria') {
                                                                            echo 'selected';
                                                                        } ?>>Nigeria</option>
                                                <option value="Niue" <?php if ($profile_data_modal->country == 'Niue') {
                                                                            echo 'selected';
                                                                        } ?>>Niue</option>
                                                <option value="Norfolk Island" <?php if ($profile_data_modal->country == 'Norfolk Island') {
                                                                                    echo 'selected';
                                                                                } ?>>Norfolk Island</option>
                                                <option value="Norway" <?php if ($profile_data_modal->country == 'Morocco') {
                                                                            echo 'selected';
                                                                        } ?>>Norway</option>
                                                <option value="Oman" <?php if ($profile_data_modal->country == 'Oman') {
                                                                            echo 'selected';
                                                                        } ?>>Oman</option>
                                                <option value="Pakistan" <?php if ($profile_data_modal->country == 'Pakistan') {
                                                                                echo 'selected';
                                                                            } ?>>Pakistan</option>
                                                <option value="Palau Island" <?php if ($profile_data_modal->country == 'Palau Island') {
                                                                                    echo 'selected';
                                                                                } ?>>Palau Island</option>
                                                <option value="Palestine" <?php if ($profile_data_modal->country == 'Palestine') {
                                                                                echo 'selected';
                                                                            } ?>>Palestine</option>
                                                <option value="Panama" <?php if ($profile_data_modal->country == 'Panama') {
                                                                            echo 'selected';
                                                                        } ?>>Panama</option>
                                                <option value="Papua New Guinea" <?php if ($profile_data_modal->country == 'Papua New Guinea') {
                                                                                        echo 'selected';
                                                                                    } ?>>Papua New Guinea</option>
                                                <option value="Paraguay" <?php if ($profile_data_modal->country == 'Paraguay') {
                                                                                echo 'selected';
                                                                            } ?>>Paraguay</option>
                                                <option value="Peru" <?php if ($profile_data_modal->country == 'Peru') {
                                                                            echo 'selected';
                                                                        } ?>>Peru</option>
                                                <option value="Phillipines" <?php if ($profile_data_modal->country == 'Phillipines') {
                                                                                echo 'selected';
                                                                            } ?>>Philippines</option>
                                                <option value="Pitcairn Island" <?php if ($profile_data_modal->country == 'Pitcairn Island') {
                                                                                    echo 'selected';
                                                                                } ?>>Pitcairn Island</option>
                                                <option value="Poland" <?php if ($profile_data_modal->country == 'Poland') {
                                                                            echo 'selected';
                                                                        } ?>>Poland</option>
                                                <option value="Portugal" <?php if ($profile_data_modal->country == 'Portugal') {
                                                                                echo 'selected';
                                                                            } ?>>Portugal</option>
                                                <option value="Puerto Rico" <?php if ($profile_data_modal->country == 'Puerto Rico') {
                                                                                echo 'selected';
                                                                            } ?>>Puerto Rico</option>
                                                <option value="Qatar" <?php if ($profile_data_modal->country == 'Qatar') {
                                                                            echo 'Qatar';
                                                                        } ?>>Qatar</option>
                                                <option value="Republic of Montenegro" <?php if ($profile_data_modal->country == 'Republic of Serbia') {
                                                                                            echo 'selected';
                                                                                        } ?>>Republic of Montenegro</option>
                                                <option value="Republic of Serbia" <?php if ($profile_data_modal->country == 'Morocco') {
                                                                                        echo 'selected';
                                                                                    } ?>>Republic of Serbia</option>
                                                <option value="Reunion" <?php if ($profile_data_modal->country == 'Reunion') {
                                                                            echo 'selected';
                                                                        } ?>>Reunion</option>
                                                <option value="Romania" <?php if ($profile_data_modal->country == 'Romania') {
                                                                            echo 'selected';
                                                                        } ?>>Romania</option>
                                                <option value="Russia" <?php if ($profile_data_modal->country == 'Russia') {
                                                                            echo 'selected';
                                                                        } ?>>Russia</option>
                                                <option value="Rwanda" <?php if ($profile_data_modal->country == 'Rwanda') {
                                                                            echo 'selected';
                                                                        } ?>>Rwanda</option>
                                                <option value="St Barthelemy" <?php if ($profile_data_modal->country == 'St Barthelemy') {
                                                                                    echo 'selected';
                                                                                } ?>>St Barthelemy</option>
                                                <option value="St Eustatius" <?php if ($profile_data_modal->country == 'St Eustatius') {
                                                                                    echo 'selected';
                                                                                } ?>>St Eustatius</option>
                                                <option value="St Helena" <?php if ($profile_data_modal->country == 'St Helena') {
                                                                                echo 'selected';
                                                                            } ?>>St Helena</option>
                                                <option value="St Kitts-Nevis" <?php if ($profile_data_modal->country == 'St Kitts-Nevis') {
                                                                                    echo 'selected';
                                                                                } ?>>St Kitts-Nevis</option>
                                                <option value="St Lucia" <?php if ($profile_data_modal->country == 'St Lucia') {
                                                                                echo 'selected';
                                                                            } ?>>St Lucia</option>
                                                <option value="St Maarten" <?php if ($profile_data_modal->country == 'St Maarten') {
                                                                                echo 'selected';
                                                                            } ?>>St Maarten</option>
                                                <option value="St Pierre & Miquelon" <?php if ($profile_data_modal->country == 'St Pierre & Miquelon') {
                                                                                            echo 'selected';
                                                                                        } ?>>St Pierre & Miquelon</option>
                                                <option value="St Vincent & Grenadines" <?php if ($profile_data_modal->country == 'St Vincent & Grenadines') {
                                                                                            echo 'selected';
                                                                                        } ?>>St Vincent & Grenadines</option>
                                                <option value="Saipan" <?php if ($profile_data_modal->country == 'Saipan') {
                                                                            echo 'selected';
                                                                        } ?>>Saipan</option>
                                                <option value="Samoa" <?php if ($profile_data_modal->country == 'Samoa') {
                                                                            echo 'selected';
                                                                        } ?>>Samoa</option>
                                                <option value="Samoa American" <?php if ($profile_data_modal->country == 'Samoa American') {
                                                                                    echo 'selected';
                                                                                } ?>>Samoa American</option>
                                                <option value="San Marino" <?php if ($profile_data_modal->country == 'San Marino') {
                                                                                echo 'selected';
                                                                            } ?>>San Marino</option>
                                                <option value="Sao Tome & Principe" <?php if ($profile_data_modal->country == 'Sao Tome & Principe') {
                                                                                        echo 'selected';
                                                                                    } ?>>Sao Tome & Principe</option>
                                                <option value="Saudi Arabia" <?php if ($profile_data_modal->country == 'Saudi Arabia') {
                                                                                    echo 'selected';
                                                                                } ?>>Saudi Arabia</option>
                                                <option value="Senegal" <?php if ($profile_data_modal->country == 'Senegal') {
                                                                            echo 'selected';
                                                                        } ?>>Senegal</option>
                                                <option value="Seychelles" <?php if ($profile_data_modal->country == 'Seychelles') {
                                                                                echo 'selected';
                                                                            } ?>>Seychelles</option>
                                                <option value="Sierra Leone" <?php if ($profile_data_modal->country == 'Singapore') {
                                                                                    echo 'selected';
                                                                                } ?>>Sierra Leone</option>
                                                <option value="Singapore" <?php if ($profile_data_modal->country == 'Morocco') {
                                                                                echo 'selected';
                                                                            } ?>>Singapore</option>
                                                <option value="Slovakia" <?php if ($profile_data_modal->country == 'Slovakia') {
                                                                                echo 'selected';
                                                                            } ?>>Slovakia</option>
                                                <option value="Slovenia" <?php if ($profile_data_modal->country == 'Slovenia') {
                                                                                echo 'selected';
                                                                            } ?>>Slovenia</option>
                                                <option value="Solomon Islands" <?php if ($profile_data_modal->country == 'Solomon Islands') {
                                                                                    echo 'selected';
                                                                                } ?>>Solomon Islands</option>
                                                <option value="Somalia" <?php if ($profile_data_modal->country == 'Somalia') {
                                                                            echo 'selected';
                                                                        } ?>>Somalia</option>
                                                <option value="South Africa" <?php if ($profile_data_modal->country == 'South Africa') {
                                                                                    echo 'selected';
                                                                                } ?>>South Africa</option>
                                                <option value="Spain" <?php if ($profile_data_modal->country == 'Spain') {
                                                                            echo 'selected';
                                                                        } ?>>Spain</option>
                                                <option value="Sri Lanka" <?php if ($profile_data_modal->country == 'Sri Lanka') {
                                                                                echo 'selected';
                                                                            } ?>>Sri Lanka</option>
                                                <option value="Sudan" <?php if ($profile_data_modal->country == 'Sudan') {
                                                                            echo 'selected';
                                                                        } ?>>Sudan</option>
                                                <option value="Suriname" <?php if ($profile_data_modal->country == 'Suriname') {
                                                                                echo 'selected';
                                                                            } ?>>Suriname</option>
                                                <option value="Swaziland" <?php if ($profile_data_modal->country == 'Swaziland') {
                                                                                echo 'selected';
                                                                            } ?>>Swaziland</option>
                                                <option value="Sweden" <?php if ($profile_data_modal->country == 'Sweden') {
                                                                            echo 'selected';
                                                                        } ?>>Sweden</option>
                                                <option value="Switzerland" <?php if ($profile_data_modal->country == 'Switzerland') {
                                                                                echo 'selected';
                                                                            } ?>>Switzerland</option>
                                                <option value="Syria" <?php if ($profile_data_modal->country == 'Syria') {
                                                                            echo 'selected';
                                                                        } ?>>Syria</option>
                                                <option value="Tahiti" <?php if ($profile_data_modal->country == 'Tahiti') {
                                                                            echo 'selected';
                                                                        } ?>>Tahiti</option>
                                                <option value="Taiwan" <?php if ($profile_data_modal->country == 'Taiwan') {
                                                                            echo 'selected';
                                                                        } ?>>Taiwan</option>
                                                <option value="Tajikistan" <?php if ($profile_data_modal->country == 'Tajikistan') {
                                                                                echo 'selected';
                                                                            } ?>>Tajikistan</option>
                                                <option value="Tanzania" <?php if ($profile_data_modal->country == 'Tanzania') {
                                                                                echo 'selected';
                                                                            } ?>>Tanzania</option>
                                                <option value="Thailand" <?php if ($profile_data_modal->country == 'Thailand') {
                                                                                echo 'selected';
                                                                            } ?>>Thailand</option>
                                                <option value="Togo" <?php if ($profile_data_modal->country == 'Togo') {
                                                                            echo 'selected';
                                                                        } ?>>Togo</option>
                                                <option value="Tokelau" <?php if ($profile_data_modal->country == 'Tokelau') {
                                                                            echo 'selected';
                                                                        } ?>>Tokelau</option>
                                                <option value="Tonga" <?php if ($profile_data_modal->country == 'Tonga') {
                                                                            echo 'selected';
                                                                        } ?>>Tonga</option>
                                                <option value="Trinidad & Tobago" <?php if ($profile_data_modal->country == 'Trinidad & Tobago') {
                                                                                        echo 'selected';
                                                                                    } ?>>Trinidad & Tobago</option>
                                                <option value="Tunisia" <?php if ($profile_data_modal->country == 'Tunisia') {
                                                                            echo 'selected';
                                                                        } ?>>Tunisia</option>
                                                <option value="Turkey" <?php if ($profile_data_modal->country == 'Turkey') {
                                                                            echo 'selected';
                                                                        } ?>>Turkey</option>
                                                <option value="Turkmenistan" <?php if ($profile_data_modal->country == 'Turkmenistan') {
                                                                                    echo 'selected';
                                                                                } ?>>Turkmenistan</option>
                                                <option value="Turks & Caicos Is" <?php if ($profile_data_modal->country == 'Turks & Caicos Is') {
                                                                                        echo 'selected';
                                                                                    } ?>>Turks & Caicos Is</option>
                                                <option value="Tuvalu" <?php if ($profile_data_modal->country == 'Tuvalu') {
                                                                            echo 'selected';
                                                                        } ?>>Tuvalu</option>
                                                <option value="Uganda" <?php if ($profile_data_modal->country == 'Uganda') {
                                                                            echo 'selected';
                                                                        } ?>>Uganda</option>
                                                <option value="United Kingdom" <?php if ($profile_data_modal->country == 'United Kingdom') {
                                                                                    echo 'selected';
                                                                                } ?>>United Kingdom</option>
                                                <option value="Ukraine" <?php if ($profile_data_modal->country == 'Ukraine') {
                                                                            echo 'selected';
                                                                        } ?>>Ukraine</option>
                                                <option value="United Arab Erimates" <?php if ($profile_data_modal->country == 'United Arab Erimates') {
                                                                                            echo 'selected';
                                                                                        } ?>>United Arab Emirates</option>
                                                <option value="United States of America" <?php if ($profile_data_modal->country == 'United States of America') {
                                                                                                echo 'selected';
                                                                                            } ?>>United States of America</option>
                                                <option value="Uraguay" <?php if ($profile_data_modal->country == 'Uraguay') {
                                                                            echo 'selected';
                                                                        } ?>>Uruguay</option>
                                                <option value="Uzbekistan" <?php if ($profile_data_modal->country == 'Uzbekistan') {
                                                                                echo 'selected';
                                                                            } ?>>Uzbekistan</option>
                                                <option value="Vanuatu" <?php if ($profile_data_modal->country == 'Vanuatu') {
                                                                            echo 'selected';
                                                                        } ?>>Vanuatu</option>
                                                <option value="Vatican City State" <?php if ($profile_data_modal->country == 'Vatican City State') {
                                                                                        echo 'selected';
                                                                                    } ?>>Vatican City State</option>
                                                <option value="Venezuela" <?php if ($profile_data_modal->country == 'Venezuela') {
                                                                                echo 'selected';
                                                                            } ?>>Venezuela</option>
                                                <option value="Vietnam" <?php if ($profile_data_modal->country == 'Vietnam') {
                                                                            echo 'selected';
                                                                        } ?>>Vietnam</option>
                                                <option value="Virgin Islands (Brit)" <?php if ($profile_data_modal->country == 'Virgin Islands (Brit)') {
                                                                                            echo 'selected';
                                                                                        } ?>>Virgin Islands (Brit)</option>
                                                <option value="Virgin Islands (USA)" <?php if ($profile_data_modal->country == 'Virgin Islands (USA)') {
                                                                                            echo 'selected';
                                                                                        } ?>>Virgin Islands (USA)</option>
                                                <option value="Wake Island" <?php if ($profile_data_modal->country == 'Wake Island') {
                                                                                echo 'selected';
                                                                            } ?>>Wake Island</option>
                                                <option value="Wallis & Futana Is" <?php if ($profile_data_modal->country == 'Wallis & Futana Is') {
                                                                                        echo 'selected';
                                                                                    } ?>>Wallis & Futana Is</option>
                                                <option value="Yemen" <?php if ($profile_data_modal->country == 'Yemen') {
                                                                            echo 'selected';
                                                                        } ?>>Yemen</option>
                                                <option value="Zaire" <?php if ($profile_data_modal->country == 'Zaire') {
                                                                            echo 'selected';
                                                                        } ?>>Zaire</option>
                                                <option value="Zambia" <?php if ($profile_data_modal->country == 'Zambia') {
                                                                            echo 'selected';
                                                                        } ?>>Zambia</option>
                                                <option value="Zimbabwe" <?php if ($profile_data_modal->country == 'Zimbabwe') {
                                                                                echo 'selected';
                                                                            } ?>>Zimbabwe</option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="city" class="imit-font fw-500 text-dark fz-16 mb-2">City</label>
                                            <input name="city" id="city" type="text" class="form-control imit-font fz-14 text-dark fw-400 rz-border" placeholder="" value="<?php echo $profile_data_modal->city; ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input name="language" type="text" class="form-control imit-font fz-14 mt-1 rz-border" id="input-tags" placeholder="e.g. English,German,Italian" value="<?php echo $profile_data_modal->languages; ?>">
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="" class="imit-font fz-14 fw-500 fz-16">Knows</label>
                                    <span class="rz-secondary-color fz-12 imit-font">Seperate with (,) coma.</span>
                                    <input name="skill" type="text" class="form-control imit-font fz-14 mt-1 rz-border" placeholder="e.g. php,wordpress,laravel" value="<?php echo $profile_data_modal->skill; ?>">
                                </div>
                            </div>
    ...
    if (wp_verify_nonce($nonce, 'rz-change-profile-user-nonce')) {
        ...
        if (!empty($image) && in_array($ext, $format)) {
            ...
            if (!empty($get_profile_data)) {
                $image_data = wp_upload_bits($unique_name . '-full.' . $ext, null, file_get_contents($image_tmp));

                $image_url = $image_data['url'];

                $path = str_replace($unique_name . '-full.' . $ext, "", $image_data['file']);

                $image_resize = wp_get_image_editor($image_data['file']);
                if (!is_wp_error($image_resize)) {
                    $image_resize->resize(150, 150, false);
                    $image_resize->save($path . $unique_name . '-mobile.' . $ext);
                }

                $path_to_site_url = str_replace(ABSPATH, site_url() . '/', $path . $unique_name . '-mobile.' . $ext);

                $wpdb->update($rz_user_profile_data, [
                    'profile_image' => json_encode([
                        'full' => $image_url,
                        'mobile' => $path_to_site_url
                    ])
                ], ['user_id' => $user_id]);


                $profile_image = json_decode($get_profile_data->profile_image);

                $full_image = str_replace(site_url() . '/', ABSPATH, $profile_image->full);
                $mobile_image = str_replace(site_url() . '/', ABSPATH, $profile_image->mobile);
...
add_action('wp_ajax_imit_update_profile_data', function () {
    ...
    if (wp_verify_nonce($nonce, 'rz-profile-update-nonce')) {
        ...
        if (empty($first_name) || empty($last_name)) {
            $response['message'] = 'First name and Last name required.';
            $response['error'] = true;
        } else {
            $rz_user_profile_data = $wpdb->prefix . 'rz_user_profile_data';
...
add_shortcode('imit-user-profile-image', function () {
    ...
    ?>
        <div class="dropdown profile-menu">
            <a href="#" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"><img src="<?php echo getProfileImageById($user_id); ?>" alt="" id="imit-header-profile-image"></a>
            <ul class="dropdown-menu mt-2 profile-dropdown shadow border-0" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item imit-font fz-14 text-dark" href="<?php echo site_url(); ?>/user"><i class="fas fa-user me-1"></i>Profile</a></li>
                <li><a class="dropdown-item imit-font fz-14 text-dark" href="<?php echo site_url(); ?>/message"><i class="fas fa-envelope me-1"></i>Message</a></li>
                                ...
                                <div class="question-first-answer">
                                    ...
                                    <ul class="answers py-3 px-4 mb-0">
                                        <li class="answer-list list-unstyled">
                                            <div class="answer-header border-bottom-0 d-flex flex-sm-row flex-column justify-content-between align-items-sm-center align-items-start">
                                                ...
                                                <p class="rz-secondary-color imit-font fz-14 mb-0 mt-sm-0 mt-2">Answered: 3pm April 25 ,2021</p>
                                            </div>
                                            <div class="answer-body mt-3 d-flex flex-row justify-content-start align-items-start">
                                                ...
                                                <ul class="body-left d-flex flex-column justify-content-start align-items-center ps-0 mb-0" id="vote<?php echo $answer_id; ?>">
                                                    <li class="list-unstyled">
                                                        <a href="#" class="vote d-block <?php if (count($get_upvote) > 0) {
                                                                                            echo 'active';
                                                                                        } ?>" <?php echo ((is_user_logged_in()) ? 'data-answer_id="' . $answer_id . '" id="up-vote"' : 'data-bs-toggle="modal" data-bs-target="#login-modal"'); ?>><i class="fas fa-arrow-up"></i></a>
                                                    </li>
                                                    <li class="list-unstyled">
                                                        <p class="counter fz-16 imit-font my-1 text-dark" id="counter<?php echo $answer_id; ?>"><?php echo count($count_upvote); ?></p>
                                                    </li>
                                                    <li class="list-unstyled">
                                                        <a href="#" class="vote d-block <?php if (count($get_downvote) > 0) {
                                                                                            echo 'active';
                                                                                        } ?>" <?php echo ((is_user_logged_in()) ? 'data-answer_id="' . $answer_id . '" id="down-vote"' : 'data-bs-toggle="modal" data-bs-target="#login-modal"') ?>><i class="fas fa-arrow-down"></i></a>
                                                    </li>
                                                </ul>
            ...
            if ($following_questions->have_posts()) {
                ...
                ?>
                    <li class="question-list rz-border rz-br p-4 mt-3 list-unstyled bg-white">
                        <div class="d-flex flex-row justify-content-between align-items-center">
                            <p class="mb-0 rz-secondary-color fz-14 imit-font">Asked on: <?php the_time('g:i a F d, Y'); ?></p>
                            <?php if (is_user_logged_in()) { ?>
                                <button type="button" class="border-0 <?php echo ((!empty($is_user_already_followed_question)) ? 'rz-color' : 'rz-secondary-color'); ?> fz-14 p-0 bg-transparent" id="follow-question-profile" data-question_id="<?php echo $post_id; ?>"><?php echo ((!empty($is_user_already_followed_question)) ? '<i class="fas fa-check-square"></i>' : '<i class="fas fa-plus-circle"></i>'); ?></button>
                            <?php } ?>
                        </div>
                        ...
                        <ul class="tags ps-0 mb-0">
                            ...
                            foreach ($tags as $tag) {
                            ?>
                                <li class="list-unstyled tag-list d-inline-block">
                    ...
                    <div class="card rz-br rz-border">
                        <div class="card-body rz-br rz-border p-0">
                            <div class="d-flex flex-row justify-content-start align-items-center py-3 px-4 pb-0">
                                <a href="<?php echo site_url() . '/user/' . $user_data->user_login; ?>" class="user-avatar rounded-circle d-block" style="width: 42px;height: 42px;">
                                    <img id="profile_image_show" src="<?php echo getProfileImageById($follower_id); ?>" alt="" class="rounded-circle" style="width: 42px;height: 42px;">
                                </a>
                                <div class="ms-2">
                                    <a href="<?php echo site_url() . '/user/' . $user_data->user_login; ?>" class="d-block username fz-16 text-dark fw-500 imit-font text-decoration-none" id="name<?php echo $follower_id; ?>"><?php echo getUserNameById($follower_id); ?></a>
                                    <?php
                            ...
                            <div class="profile-action d-flex flex-sm-row flex-column justify-content-between align-items-center py-3 px-4">
                                ...
                                if (get_current_user_id() != $follower_id) {
                                    ...
                                    $get_all_followers = $wpdb->get_results("SELECT * FROM {$wpdb->prefix}rz_followers WHERE (sender_id = '$sender_id' AND receiver_id = '$receiver_id') OR (sender_id = '$receiver_id' AND receiver_id = '$sender_id')", ARRAY_A);
                                ?>
                                    <a href="#" class="btn rz-bg-color d-block text-center imit-font fz-14 text-white w-sm-50 w-100 me-sm-1 me-0 <?php echo ((is_user_logged_in() && count($get_all_followers) > 0) ? 'following' : ''); ?>" <?php echo ((is_user_logged_in()) ? 'id="rz-follow" data-receiver_id="' . $follower_id . '"' : 'data-bs-toggle="modal" data-bs-target="#login-modal"'); ?>><?php echo ((is_user_logged_in() && count($get_all_followers) > 0) ? '<i class="fas fa-check-square me-2"></i>Following' : '<i class="fas fa-plus-circle me-2"></i>Follow'); ?></a>
                                    <a href="#" class="btn message d-block text-center imit-font mt-sm-0 mt-2 fz-14 w-sm-50 w-100 ms-sm-1 ms-0" <?php echo ((is_user_logged_in()) ? 'data-user_id="' . $receiver_id . '" id="send-message-button"' : 'data-bs-toggle="modal" data-bs-target="#login-modal"') ?>><i class="fas fa-comments me-2"></i>Message</a>
                                <?php
                                } else {
                                ?>
                                    <a href="#" class="btn follow d-block text-center imit-font fz-14 text-white w-sm-50 w-100 me-sm-1 me-0" data-bs-toggle="modal" data-bs-target="#rz-profile-edit-modal"><i class="fas fa-edit me-2"></i>Edit Profile</a>
                                    <a href="#" class="btn message d-block text-center mt-sm-0 mt-2 imit-font fz-14 w-sm-50 w-100 ms-sm-1 ms-0">Search Pad</a>
                                <?php
                                }
                                ?>
                            </div>
        ...
        if ($dairy_data->have_posts()) {
            ...
            ?>
                <li class="dairy-list list-unstyled rz-border rz-br p-3 mt-3 bg-white" id="dairy<?php echo get_the_ID(); ?>">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <p class="mb-0 rz-secondary-color imit-font fz-14">Added on: <?php the_time('g:i a F d, Y'); ?></p>
                        <?php if (is_user_logged_in() && $author_id == get_current_user_id()) : ?>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu border-0 shadow" aria-labelledby="dropdownMenuButton1">
                                    ...
                                    <li class="px-2">
                                        ...
                                        <div class="switch-button">
                                            <input class="switch-button-checkbox" name="dairy-visiblity" type="checkbox" value="public" id="dairy-visiblity" data-post_id="<?php echo get_the_ID(); ?>" <?php if (get_post_status() == 'publish') {
                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                        } ?> />
                    ...
                    <p class="dairy-text text-dark fz-16 mt-3 mb-0 imit-font" style="line-height: 32px;">
                        <?php
                        $more = '<a href="#" class="imit-font fz-16 fw-500 rz-color d-block mt-2" id="dairy-read-more" data-post_id="' . get_the_ID() . '">Read More</a>';
                        echo force_balance_tags(html_entity_decode(wp_trim_words(htmlentities(wpautop(get_the_content())), 100, $more))); ?>
                    </p>
                    <div class="dairy-text text-dark fz-16 mt-3 mb-0 imit-font" style="line-height: 32px;display: none;" id="dairy-text-expand<?php echo get_the_ID(); ?>"><?php echo get_the_content(); ?><div>
                </li>
            <?php
            endwhile;
        } else {
    ...
    if (wp_verify_nonce($nonce, 'rz-redeem-point-nonce')) {
        ...
        if (empty($point) || empty($payment_method)) {
            ...
            if ($payment_method == 'Paytm' && (empty($name) || empty($mobile))) {
                ...
                wp_mail('support@recozilla.com', $subject, $message, $headers);
...
function get_all_profile_following_tags()
{
    ...
    if (wp_verify_nonce($nonce, 'rz-get-following-tags-nonce')) {
        ...
        if (count($all_following_tags) > 0) {
            ...
            ?>
                <li class="hash-list list-unstyled col-sm-6 col-12 my-2">
                    <div class="bg-white py-2 px-3 rounded border">
                        <div class="hash-top d-flex flex-row justify-content-between align-items-center">
                            ...
                            <button type="button" class="add-post-by-tag p-0 <?php if (!empty($is_user_already_followed)) {
                                                                                ...
                                                                                } ?> bg-transparent fz-14 border-0" data-term_id="<?php echo $term_d->term_id; ?>" id="follow-tag"><?php if (!empty($is_user_already_followed)) {
 ...
 * change password
 */
add_action('wp_ajax_rz_change_password_data', function () {
    $nonce = $_POST['nonce'];
    if (wp_verify_nonce($nonce, 'rz-change-password-nonce')) {
        ...
        $logged_in = sanitize_text_field($_POST['logged-in']);
        ...
        if (empty($old_password) || empty($new_password) || empty($confirm_password)) {
            ...
            $response['error'] = true;
        } else if (wp_check_password($old_password, $user_data->user_pass, get_current_user_id()) == false) {
            $response['message'] = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Warning!</strong> Old password not matched.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>';
            $response['error'] = true;
        } else if (strlen($new_password) < 8) {
            $response['message'] = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <strong>Warning!</strong> Password at least 8 characters.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>';
            $response['error'] = true;
            ...
            $response['logout_url'] = wp_logout_url(site_url() . '/login');
